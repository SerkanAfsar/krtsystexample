...
const CustomDatatable = ({
  ...
  return (
    ...
    >
      ...
      <table
        {...getTableProps()}
        className="datatable-table min-w-full table-auto !border-collapse overflow-auto break-words !border-t border-stroke px-4 dark:border-strokedark md:table-fixed md:overflow-auto md:px-8"
      >
        <thead>
