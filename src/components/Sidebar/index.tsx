...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-10 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark xl:static xl:translate-x-0 ${
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/tasks" || pathname.includes("StokYonetimi")
                }
              >
                {(handleClick, open) => {
                  return (
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/tasks" || pathname.includes("IsEmirleri")
                }
              >
                {(handleClick, open) => {
                  return (
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/Finans" || pathname.includes("Finans")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-3 mt-4 flex flex-col gap-2.5 pl-3">
                          <li>
                            <Link
                              href="/Admin/Finans/Kurlar"
                              className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                (pathname === "/Kurlar" ||
                                  pathname.includes("Kurlar")) &&
                                "bg-graydark dark:bg-meta-4"
                              }`}
                            >
                              Kurlar
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/Magazalar" || pathname.includes("Magazalar")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-3 mt-4 flex flex-col gap-2.5 pl-3">
                          <li>
                            <Link
                              href="/Admin/Magazalar/MagazaEkle"
                              className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                (pathname === "/Admin/Magazalar/MagazaEkle" ||
                                  pathname.includes("MagazaEkle")) &&
                                "bg-graydark dark:bg-meta-4"
                              }`}
                            >
                              Mağaza Ekle
                          ...
                          <li>
                            <Link
                              href="/Admin/Magazalar/MagazaListesi"
                              className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                (pathname ===
                                  "/Admin/Magazalar/MagazaListesi" ||
                                  pathname.includes("MagazaListesi")) &&
                                "bg-graydark dark:bg-meta-4"
                              }`}
                            >
                              Mağaza Listesi
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/Firmalar" || pathname.includes("Firmalar")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-3 mt-4 flex flex-col gap-2.5 pl-3">
                                ...
                                <React.Fragment>
                                  ...
                                  >
                                    <ul className="mb-3 mt-4 flex flex-col gap-2.5 pl-6">
                                      <li>
                                        <Link
                                          href="/Admin/Firmalar/Tedarikciler/TedarikciEkle"
                                          className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                            pathname ===
                                              "/Admin/Firmalar/Tedarikciler/TedarikciEkle" &&
                                            "text-white"
                                          }`}
                                        >
                                          Tedarikçi Ekle
                                      ...
                                      <li>
                                        <Link
                                          href="/Admin/Firmalar/Tedarikciler/TedarikciListesi"
                                          className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                            pathname ===
                                ...
                                <React.Fragment>
                                  ...
                                  >
                                    <ul className="mb-3 mt-4 flex flex-col gap-2.5 pl-6">
                                      <li>
                                        <Link
                                          href="/Admin/Firmalar/Musteriler/MusteriEkle"
                                          className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                            pathname ===
                                              "/Admin/Firmalar/Musteriler/MusteriEkle" &&
                                            "text-white"
                                          }`}
                                        >
                                          Müşteri Ekle
                                      ...
                                      <li>
                                        <Link
                                          href="/Admin/Firmalar/Musteriler/MusteriListesi"
                                          className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                            pathname ===
                                              "/Admin/Firmalar/Musteriler/MusteriListesi" &&
                                            "text-white"
                                          } `}
                                        >
                                          Müşteri Listesi
                          ...
                          <SidebarLinkGroup
                            activeCondition={
                              pathname === "/Atolyeler" || pathname.includes("Atolyeler")
                            }
                          >
                            {(handleClick, open) => {
                              return (
                                <React.Fragment>
                                  ...
                                  >
                                    <ul className="mb-3 mt-4 flex flex-col gap-2.5 pl-6">
                                      <li>
                                        <Link
                                          href="/Admin/Firmalar/Atolyeler/AtolyeEkle"
                                          className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                            pathname === "/Admin/Firmalar/Atolyeler/AtolyeEkle" && "text-white"
                                          }`}
                                        >
                                          Atölye Ekle
                                        </Link>
                                      ...
                                      <li>
                                        <Link
                                          href="/Admin/Firmalar/Atolyeler/AtolyeListesi"
                                          className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                            pathname === "/Admin/Firmalar/Atolyeler/AtolyeListesi" && "text-white"
                                          } `}
                                        >
                                          Atölye Listesi
                                        </Link>
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/Satislar" || pathname.includes("Satislar")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-3 mt-4 flex flex-col gap-2.5 pl-3">
                          <li>
                            <Link
                              href="/Admin/Satislar/SatisEkle"
                              className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                (pathname === "/Admin/Satislar/SatisEkle" ||
                                  pathname.includes(
                                    "/Admin/Satislar/SatisEkle",
                                  )) &&
                                "bg-graydark dark:bg-meta-4"
                              }`}
                            >
                          ...
                          <li>
                            <Link
                              href="/Admin/Satislar/SatisListesi"
                              className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                (pathname === "/Admin/Satislar/SatisListesi" ||
                                  pathname.includes(
                                    "/Admin/Satislar/SatisListesi",
                                  )) &&
                                "bg-graydark dark:bg-meta-4"
                              }`}
                            >
