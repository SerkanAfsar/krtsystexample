    ...
    <div className="h-1 min-h-screen rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex h-full flex-wrap items-center">
        ...
        <div className="flex h-full w-full items-center border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 !pb-0 sm:p-12.5 xl:p-17.5">
            {!isForgot ? (
              <>
                <div className="w-full p-4 sm:p-12.5 xl:p-17.5 xl:py-12">
                  <span className="mb-1.5 block font-medium">Atilla Karat</span>
                  ...
                  <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="mb-4">
                      ...
                      {errors["email"] && (
                        <span className="mt-2 block w-full text-right text-red">
                    ...
                    {errList && (
                      <b className="mt-4 block  text-center text-sm capitalize text-red">
                        {errList}
                      </b>
                    )}
