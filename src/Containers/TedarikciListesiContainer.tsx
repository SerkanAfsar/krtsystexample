...
export default function TedarikciListesiContainer() {
  const {
    activeData,
    activePage,
    totalPageCount,
      ...
      {error ? (
        ...
        <>
          <CustomDeleteModal
            ...
            modalTitle="Kayıtlı Tedarikçiyi Silmek İstediğinizden Emin misiniz?"
            modalDescription="Tedarikçi Bilgileri Kalıcı Olarak Silinecektir."
