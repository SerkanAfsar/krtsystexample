...
export const AddTedarikciSections: Array<FormSectionType> = [
  {
    ...
    elements: [
      ...
      },
      {
        name: "post_code",
        type: "text",
        title: "Tedarikçi Posta Kodu",
        placeholder: "Tedarikçi Posta Kodu Giriniz...",
        required: true,
        requiredMessage: "Tedarikçi Posta Kodu Boş Bırakılamaz",
        span: 2,
      },
      ...
      },
      {
        ...
        placeholder: "Tedarikçi Türü Giriniz...",
        required: true,
        requiredMessage: "Tedarikçi Türü Boş Bırakılamaz",
        span: 2,
        moveToTop: true,
        isTopMargin: true,
        colStart: "3",
    ...
    elements: [
      {
        ...
        required: true,
        requiredMessage: "Banka Boş Bırakılamaz",
        span: 2,
      },
      {
        name: "iban",
        ...
        required: true,
        requiredMessage: "Iban Boş Bırakılamaz",
        span: 2,
      },
      {
        name: "swift_code",
        ...
        required: true,
        requiredMessage: "Swift Code Boş Bırakılamaz",
        span: 2,
      },
      {
        name: "tax_number",
...
export const AddStoneSections: Array<FormSectionType> = [
  ...
  },
  {
    ...
    groupNumber: 0,
    keyString: "product_certificate1",
    elements: [
      {
        name: "sertifika",
        type: "select",
  ...
  },
  {
    ...
    groupNumber: 0,
    keyString: "product_certificate2",
    elements: [
      {
        name: "propotion",
        type: "select",
  ...
  {
    colsLenght: "4",
    sectionTitle: "Pırlanta Fiyat Bilgileri Sertifikalı",
    groupNumber: 0,
    keyString: "product_cost1",
    visibleRelativeColumn: "menstrual_status",
    visibleRelativeToValue: "Sertifikalı",
    elements: [
      {
  ...
  },
  {
    ...
    groupNumber: 0,
    keyString: "product_cost2",
    visibleRelativeColumn: "menstrual_status",
    visibleRelativeToValue: "Sertifikasız",
    elements: [
      {
        name: "buy_date",
        type: "datepicker",
      ...
      },
      {
        ...
        placeholder: "Maliyet",
        required: false,
        requiredMessage: "Toplam Maliyet Bırakılamaz",
        rightIcon: "$",
        disabled: true,
        relativeTo: "menstrual_status",
        span: 1,
      ...
      },
      {
        name: "total_cost",
        type: "money",
        title: "Toplam Ana Maliyet",
        placeholder: "Maliyet",
        required: false,
        requiredMessage: "Toplam Maliyet",
        rightIcon: "$",
        disabled: true,
        relativeTo: "menstrual_status",
        span: 1,
  ...
  {
    colsLenght: "12",
    sectionTitle: "Pırlanta Fiyat Bilgileri Detay",
    groupNumber: 0,
    keyString: "product_cost3",
    visibleRelativeColumn: "menstrual_status",
    visibleRelativeToValue: "Sertifikasız",
    elements: [
      {
      ...
      },
      {
        ...
        type: "money",
        title: "Toplam Ana Maliyet",
        placeholder: "Toplam Ana Maliyet",
        required: false,
        requiredMessage: "Toplam Maliyet",
        rightIcon: "$",
        disabled: true,
      ...
      {
        name: "toplamLotMaliyet",
        type: "text",
        placeholder: "PPC Maliyet",
        title: "Toplam PPC Maliyet",
        relativeTo: "menstrual_status",
        required: false,
        disabled: true,
        colStart: "9",
      ...
      {
        name: "toplamUretimMaliyeti",
        type: "text",
        placeholder: "Üretim Maliyet",
        title: "Toplam Üretim Maliyet",
        relativeTo: "menstrual_status",
        required: false,
        disabled: true,
        colStart: "11",
    ...
    elements: [
      {
        ...
        options: RenkliTasSertifikaKodlari,
      },
      {
        name: "sertifikaNo",
        type: "text",
